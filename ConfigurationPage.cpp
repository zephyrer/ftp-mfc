	...
	, m_nKeeptime(0)
{
	...
	m_strWelcomeMessage = AfxGetApp()->GetProfileString("ftp_Settings", "WelcomeMsg", "°¥à¡£¬²»´íÅ¶!");
	m_strGoodbyeMessage = AfxGetApp()->GetProfileString("ftp_Settings", "GoobyeMsg", "ÔÙÀ´³éËÀÑ¾!");
